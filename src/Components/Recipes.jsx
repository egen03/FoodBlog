    ...
    return(
        ...
        {/* class="row row-cols-1 row-cols-sm-2" */}
            ...
            <div class="card col mb-4">
                ...
                <div className="foodImage">
                <img src={require("/Users/student_ga111/Desktop/Cassini /mod2/foodblog/foodblog/src/Images/italian.jpeg")} class="card-img-top" alt="Italian Food" height="500px" width="700px" />
                </div>
            ...
            <div class="card col mb-4">
                ...
                <div className="foodImage">
                <img src={require("/Users/student_ga111/Desktop/Cassini /mod2/foodblog/foodblog/src/Images/french.jpeg")} class="card-img-top" alt="French Food" height="500px" width="700px" />
                </div>
